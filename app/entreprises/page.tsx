      ...
      <main>
        ...
        <section className="bg-white py-16 md:py-20">
          <div className="mx-auto max-w-5xl px-6 md:px-10">
            ...
            <div className="grid gap-6 md:grid-cols-3">
              {[
                { label: c.get('price_1_label', 'Coaching dirigeant'), price: c.get('price_1_price', 'Sur devis'), unit: c.get('price_1_unit', ''), desc: 'Accompagnement individuel de dirigeants, managers et hauts potentiels. Programme sur 3 à 6 mois.', items: ['Bilan de départ et objectifs', 'Séances bimensuelles 90 min', 'Disponibilité inter-séances', 'Rapport de progression'], cta: 'Demander un devis', highlight: false },
                { label: c.get('price_2_label', 'Programme équipe'), price: c.get('price_2_price', 'Sur devis'), unit: c.get('price_2_unit', ''), desc: 'Ateliers collectifs, séminaires de cohésion et accompagnement du changement pour vos équipes.', items: ["Diagnostic d'équipe", 'Ateliers sur mesure', 'Coaching de groupe', 'Suivi post-programme'], cta: 'Discutons-en', highlight: true },
                { label: c.get('price_3_label', 'Conférence & formation'), price: c.get('price_3_price', 'Sur devis'), unit: c.get('price_3_unit', ''), desc: 'Interventions sur le leadership, la transformation, la qualité de présence et le philosophical counselling.', items: ['Format keynote ou atelier', 'Contenu personnalisé', 'Support de présentation', 'Session Q&R incluse'], cta: 'Voir les thèmes', highlight: false },
