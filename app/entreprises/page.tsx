          ...
          <div className="mx-auto max-w-2xl px-6 md:px-10">
            <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
              ...
              <blockquote lang="fr" className="mt-3 text-base leading-relaxed text-stone-700 italic">
                {c.temoignage_dorothee_text || "On a eu un super feedback sur la réunion de présentation que nous avons préparée ensemble. Jérôme (le n+1 de ma cliente) nous a dit : \"Champagne !\""}
              </blockquote>
              <footer className="mt-6">
                <p className="text-sm font-semibold text-stone-900">{c.temoignage_dorothee_author || 'Dorothée*'}</p>
                <p className="text-xs text-stone-500 italic mt-0.5">{c.temoignage_dorothee_role || 'Directrice Achats Beauty Retail'}</p>
