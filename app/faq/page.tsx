      ...
      <main className="pt-[72px]">
        ...
        <section className="relative overflow-hidden bg-stone-900 px-6 py-24 md:py-32 md:px-10 text-center">
          ...
          <div className="relative mx-auto max-w-3xl">
            ...
            <p className="mt-5 text-base text-stone-300 leading-relaxed max-w-xl mx-auto">{c.get('page_subtitle', undefined, { multiline: true })}</p>
          </div>
        </section>
        ...
        <section className="bg-[#f5f0e8] px-6 py-14 md:px-10 text-center">
          <div className="mx-auto max-w-xl">
            ...
            <p className="text-sm text-stone-500 mb-6">{c.get('cta_text', undefined, { multiline: true })}</p>
