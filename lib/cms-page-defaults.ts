...
export const PAGE_DEFAULTS: Record<string, Record<string, string>> = {
  ...
  'happiness-design': {
    hero_badge:          'Happiness Design',
    hero_title:          '12 séances pour reprendre les rênes de votre bonheur',
    hero_subtitle:       'Au boulot et ailleurs — neurosciences, psychologie, philosophie et design thinking.',
    hero_cta:            'Réserver une séance découverte →',
    pourquoi_badge:      'Pourquoi Happiness Design ?',
    pourquoi_title:      'Une boîte à outils complète pour votre vie',
    pourquoi_1_title:    'Neurosciences',
    pourquoi_1_desc:     'Comprendre comment votre cerveau fonctionne et comment il peut travailler pour vous.',
    pourquoi_2_title:    'Psychologie positive',
    pourquoi_2_desc:     'Savoir créer activement votre bonheur plutôt que d\'attendre qu\'il arrive.',
    pourquoi_3_title:    'Philosophie pratique',
    pourquoi_3_desc:     'Challenger vos pensées et trouver votre propre wisdom pour naviguer les défis.',
