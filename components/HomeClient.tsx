      ...
      <main>
        ...
        <section className="relative overflow-hidden bg-[#f4efe6]">
          ...
          <div className="relative mx-auto grid max-w-7xl gap-14 px-6 py-24 md:grid-cols-[1.2fr_0.8fr] md:px-10 md:py-32">
            <div>
              ...
              <p className="mt-7 max-w-2xl text-lg leading-relaxed text-stone-700">{c.field('hero_subtitle')}</p>
          ...
          <div className="mx-auto max-w-6xl px-6 md:px-10">
            <div className="grid items-center gap-12 md:grid-cols-2">
              <div className="space-y-5">
                ...
                <h2 className="text-3xl font-serif font-light leading-tight text-stone-900 md:text-4xl">{c.field('section_about_title')}</h2>
                <p className="text-base leading-relaxed text-stone-600">{c.field('section_about_text')}</p>
        ...
        <section className="bg-[#f7f4ef] py-20 md:py-28">
          <div className="mx-auto max-w-6xl px-6 md:px-10">
            <div className="mb-14 max-w-2xl">
              ...
              <h2 className="text-3xl font-serif font-light leading-tight text-stone-900 md:text-4xl">{c.field('services_title')}</h2>
              <p className="mt-4 text-base leading-relaxed text-stone-600">{c.field('services_subtitle')}</p>
            </div>
        ...
        <section className="bg-[#2f6b61] py-20">
          <div className="mx-auto max-w-2xl px-6 text-center">
            <h2 className="mb-4 text-3xl font-serif font-light text-white">{c.field('newsletter_title')}</h2>
            <p className="mb-8 text-base leading-relaxed text-emerald-100">{c.field('newsletter_subtitle')}</p>
